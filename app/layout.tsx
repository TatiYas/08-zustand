...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Organize your thoughts and boost productivity with NoteHub, a simple and efficient note-taking app.",
    url: "https://project-notehub.vercel.app",
    images: [
      {
        url: "/images/notehub-og-meta.jpg", // Замени на реальный путь
        width: 1200,
        height: 630,
        alt: "NoteHub Logo",
      },
